...
set_property PACKAGE_PIN U14 [get_ports {curState[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {curState[0]}]
set_property PACKAGE_PIN V14 [get_ports {curState[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {curState[1]}]
set_property PACKAGE_PIN V13 [get_ports {curState[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {curState[2]}]
